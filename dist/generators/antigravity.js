 ...
 */
export const antigravityGenerator = {
    harness: "antigravity",
    generate(config) {
        ...
        lines.push("## Local Tools (AgentOS)", "", "Deterministic tools are available via MCP — prefer them over guessing:", "- `memory` / `supersearch` / `codegraph`", "");
        const mcp = {
